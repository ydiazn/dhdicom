...
class Ui_Pruebas(object):
    def setupUi(self, Pruebas):
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 381, 210))
        self.scrollAreaWidgetContents_3.setObjectName(_fromUtf8("scrollAreaWidgetContents_3"))
        self.formLayout = QtGui.QFormLayout(self.scrollAreaWidgetContents_3)
        self.formLayout.setObjectName(_fromUtf8("formLayout"))
        self.eprTable = QtGui.QTableWidget(self.scrollAreaWidgetContents_3)
        self.eprTable.setColumnCount(0)
        self.eprTable.setObjectName(_fromUtf8("eprTable"))
        self.eprTable.setRowCount(0)
        self.formLayout.setWidget(0, QtGui.QFormLayout.FieldRole, self.eprTable)
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 381, 210))
        ...
        self.hiddenEPRTable = QtGui.QTableWidget(self.scrollAreaWidgetContents_4)
        self.hiddenEPRTable.setColumnCount(0)
        self.hiddenEPRTable.setObjectName(_fromUtf8("hiddenEPRTable"))
        self.hiddenEPRTable.setRowCount(0)
        self.formLayout_2.setWidget(0, QtGui.QFormLayout.FieldRole, self.hiddenEPRTable)
